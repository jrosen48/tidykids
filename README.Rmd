...
Detailed descriptions of the state expenditures in the dataset (see the `expenditure` column) are available in the [tidykids-codebook vignette](https://jrosen48.github.io/tidykids/articles/tidykids-codebook.html).
