...
- `inf_adj` refers to the amount transformed to be in 2016 dollars for each year
- `inf_adj_per_child` refers to the amount transformed to be in 2016 dollars for each year per child in $1000s
...
```
This can be joined to the `tidykids` data to easily access information about the variables:
...
An interactive Shiny web application is available here: https://t.co/wBPq65xM5F?amp=1
